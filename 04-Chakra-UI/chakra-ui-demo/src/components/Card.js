...
import { Box, Image, Badge, Text, Stack, Flex, Button, useColorModeValue, useColorMode } from "@chakra-ui/react";
...
export default function Card() {
  ...
  return (
    ...
    >
      ...
      <Button w="100%" colorScheme="teal" borderTopLeftRadius={0} borderTopRightRadius={0}>登录</Button>
    </Box>
  );
}
